                ...
                <div className="max-w-lg mx-auto bg-white shadow-lg rounded-lg border border-gray-200">
                    <div className="flex flex-col items-center py-8 px-6">
                        ...
                        <form className="w-full" onSubmit={handleSubmit}>
                            <div className="mb-4">
                                <label htmlFor="username" className="block text-red1 text-lg font-semibold">Username:</label> 
                                <input
                                    type="text"
                                    id="username"
                                    value={name}
                            ...
                            <div className="mb-4">
                                <label htmlFor="email" className="block text-red1 text-lg font-semibold">Email:</label> 
                                <input
                                    type="email"
                                    id="email"
                                    value={email}
                            ...
                            <button type="submit" className="bg-red1 text-white px-6 py-2 rounded-md shadow-md hover:bg-red2 focus:outline-none focus:ring-2 focus:ring-red1"> 
                                Save Changes
                            </button>
                        </form>
                    </div>
