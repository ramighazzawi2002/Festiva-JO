  ...
  return (
    <div className=" mx-auto p-4 bg-page">
          ...
          {slides.map(slide => (
            <div key={slide.id} className="relative rounded-xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white p-6">
                <h2 className="text-2xl sm:text-4xl font-bold mb-4 text-red-500">{slide.title}</h2>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="text-center md:flex md:items-center md:space-x-12">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-3xl md:text-4xl font-bold text-red-600 mb-6 md:mb-8">Why Festivals Matter</h2>
      ...
      <section className="bg-gray-100 py-12">
        <div className="container mx-auto px-6 md:px-12">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-red-600 mb-12">Explore Festivals by Category</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {festivalData.categories.map(category => (
              <div key={category.id} className="relative group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white p-6 opacity-0 group-hover:opacity-100 transition duration-300">
                  ...
                  <a href={category.link} className="bg-red-500 py-2 px-4 rounded-lg hover:bg-red-600 transition duration-300">View Category</a>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-6 md:px-12">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-red-600 mb-12">Upcoming Festivals</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {festivalData.festivals.map(festival => (
              <div key={festival.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-red-600">{festival.name}</h3>
                  ...
                  <a href={festival.link} className="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 transition duration-300">Learn More</a>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-6 md:px-12">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-red-600 mb-12">Special Offers</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {festivalData.specialOffers.map(offer => (
              <div key={offer.id} className="relative group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white p-6 opacity-0 group-hover:opacity-100 transition duration-300">
                  ...
                  <a href={offer.link} className="bg-red-500 py-2 px-4 rounded-lg hover:bg-red-600 transition duration-300">View Offer</a>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 bg-gray-100">
            <div className="container mx-auto px-6 md:px-12">
                <h2 className="text-3xl md:text-4xl font-bold text-center text-red-600 mb-12">Testimonials</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    {testimonials.map(testimonial => (
                        <div key={testimonial.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300">
                            <div className="p-6 text-center">
                                <img src={testimonial.image} alt={testimonial.name} className="w-24 h-24 rounded-full mx-auto mb-4 border-4 border-red-600" />
                                <h3 className="text-xl font-semibold mb-2 text-red-600">{testimonial.name}</h3>
                                <p className="text-sm text-gray-500 mb-2 italic">{testimonial.role}</p>
      ...
      <section className="bg-red-600 text-white py-12">
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-lg mb-6">Sign up for our newsletter to receive the latest news and updates about upcoming festivals and events.</p>
          <form onSubmit={handleSubmit} className="max-w-lg mx-auto">
            ...
            {submitted && <p className="text-green-300 mb-4">Thank you for subscribing!</p>}
          </form>
        </div>
      </section>
