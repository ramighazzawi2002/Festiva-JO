...
const CheckOut = () => {
  ...
  const [coupons] = getData('https://culture-festival-new-default-rtdb.europe-west1.firebasedatabase.app/coupons.json');
  ...
  function applyCoupon() {
    ...
    coupons.forEach(coupon => {
      if (coupon.code === couponCode) {
        ...
        couponFound = true;
        orderDetails.total -= orderDetails.total * coupon.discountPercentage / 100;
